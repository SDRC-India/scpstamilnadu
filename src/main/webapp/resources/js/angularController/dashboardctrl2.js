...
//		$scope.$apply();
	...
	$scope.selectMapAreaType = function(mapAreaType, sg, sl, sd) {
		...
		.success(function(data) {
			...
			var jsonFileName = data.jsonMapName;
			var mapUrl = data.url;
		});
...
//		switch (mapAreaType) {
//		case "District":
//			mapUrl = "resources/geomaps/Tamil_Nadu_Districts_Maps.json";
//
//			$scope.selectedChildAreaLevel = 2;
//			$scope.shouldDrilldown = true;
//			$scope.selectedGranularity = new ValueObject("IND", "India_State_Map");
//			break;
//		default:
//			mapUrl = "resources/geomaps/TamilNadu.json";
//			break;
//		}
